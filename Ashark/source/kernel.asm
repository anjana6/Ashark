;Ashark --- The Ashark Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE AsharkOs_VER '1.0.0'	 ;OS version number
	%DEFINE AsharkOs_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as AsharkOs and its programs
...
option_screen:
	...
	os_init_msg		db '--------------------------Welcome to Ashark OS----------------------------', 0
	os_version_msg		db 'Version ', AsharkOs_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', AsharkOs_VER, 0

	dialog_string_1		db 'Welcome to Ashark Operating System', 0
